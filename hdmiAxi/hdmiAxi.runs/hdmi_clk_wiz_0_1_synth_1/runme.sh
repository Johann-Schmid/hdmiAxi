...
HD_PWD='D:/hdmiAxi/hdmiAxi/hdmiAxi.runs/hdmi_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_clk_wiz_0_1.tcl
