...
HD_PWD='D:/hdmiAxi/hdmiAxi/hdmiAxi.runs/hdmi_dataGen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_dataGen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_dataGen_0_0.tcl
