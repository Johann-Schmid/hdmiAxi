...
HD_PWD='D:/hdmiAxi/hdmiAxi/hdmiAxi.runs/hdmi_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_proc_sys_reset_0_0.tcl
